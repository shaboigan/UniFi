...
echo "${Colour}By using this script, you'll remove the default pi account, update the system, install Teamviewer, install the stable UniFi controller of your choice and install Pi-hole.\nUse CTRL+C to cancel the script\n\n${less}"
